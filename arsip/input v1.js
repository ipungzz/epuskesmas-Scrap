        ...
        (async () => {
                ...
                await page.goto(url1, {
                        ...
                        if (!noDataFound){
                                ...
                                console.log (`[IFNO] Sedang Memproses Data Nama: ${dataPasien.namaPasien} JK: ${dataPasien.jenisKelamin} Tanggal Lahir: ${dataPasien.tanggalLahir} Umur: ${hasilumur.toString()} dengan rata rata tinggi ${resulttinggi} dan rata rata berat ${resultbadan}`);
                                ...
                                if (dataPasien.jenisKelamin === 'Perempuan') {
                                        ...
                                        await new Promise(resolve => setTimeout(resolve, 3000));
                                        await page.type('#tinggi_badan', resulttinggi.toString());
                                        await page.type('#berat_badan', result.toString());
                                        await new Promise(resolve => setTimeout(resolve, 3000));
                                        await page.click('#form_create > div:nth-child(3) > div:nth-child(2) > div:nth-child(4) > div > div:nth-child(2) > label');
                                        await new Promise(resolve => setTimeout(resolve, 3000));
                                        console.log('[INFO] Sedang Memasukan Nama Tenaga Medis LILIK MASUDA. AMD. KEP (Perawat)');
