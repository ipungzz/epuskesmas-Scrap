    ...
    (async () => {
            ...
            await page.goto(url, {
                ...
                await new Promise(resolve => setTimeout(resolve, 5000));
                        ...
                        while(!noDataFound){
                          let dataNoFound = await page.evaluate(() => {
                          ...
                          if(dataNoFound == false){
                            console.log('ada data disini');
                            await new Promise(resolve => setTimeout(resolve, 3000));
                            ...
                            await new Promise(resolve => setTimeout(resolve, 2000));
                            await page.waitForSelector("#button_anamnesa");
                            await new Promise(resolve => setTimeout(resolve, 2000));
                              ...
                              tables.forEach(table => {
                                ...
                                rows.forEach(row => {
                                  ...
                                  if (cells.length === 3) {  // Hanya ambil baris dengan format 3 kolom (label, :, data)
                                    ...
                                    let value = cells[2].innerText.trim();// Jika baris adalah "Tempat & Tgl Lahir", ambil hanya tanggal lahir
                                    ...
                                    if (key === 'Asuransi') {
                                      ...
                                      if (bpjsText) {// Ambil angka yang mengikuti "BPJS Kesehatan /"
                            ...
                            await page.goto(url2, {waitUntill: "networkidle2"}).then(async () =>{
                              ...
                              console.log('[INFO] Memilih Fitur Tunda');
                              await new Promise(resolve => setTimeout(resolve, 3000));
                              await page.waitForSelector("#button_fitur_tunda");
                              await page.click("#button_fitur_tunda")
                              await new Promise(resolve => setTimeout(resolve, 2000));
                              await page.click("#modal > div > div > div.modal-form > div:nth-child(1) > div > div > div > span")
                                    await new Promise(resolve => setTimeout(resolve, 2000));
